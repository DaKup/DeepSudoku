...
sudoku_dataset = dataset_base.copy({
    'name': 'Sudoku Dataset',
    
    'train_info': './data/coco/train/annotations.json',
    'valid_info': './data/coco/validation/annotations.json',

    'train_images': './data/coco/train',
    'valid_images': './data/coco/validation',

    'label_map': SUDOKU_LABEL_MAP,
    'class_names': SUDOKU_CLASSES,
})
...
sudoku_testdev_dataset = dataset_base.copy({
    'name': 'Sudoku Test-Dev',

    'valid_info': './data/coco/test/annotations.json',
    'has_gt': True,
...
yolact_sudoku_config = yolact_resnet50_config.copy({
    'name': 'yolact_sudoku',

    # Dataset stuff
    'dataset': sudoku_dataset,
    'num_classes': len(sudoku_dataset.class_names) + 1,
})

yolact_sudoku_plus_config = yolact_plus_resnet50_config.copy({
    'name': 'yolact_plus_sudoku',
